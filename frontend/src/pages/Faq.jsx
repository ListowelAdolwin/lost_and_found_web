...
const Faq = () => {
	const faq = [
		...
		{
			question: "What should I do if I've lost something?",
			answer: "If you've lost something, log in to your account on our web app and report the lost item with as many details as possible. This helps increase the chances of a successful match. We recommend regularly checking our platform for updates on items gallery that match your description.",
		},
		{
			question:
				"Can I search for a lost item without creating an account?",
