...
function SideNavbar() {
	...
	return (
		<div className="">
			...
			<div
				id="docs-sidebar"
				className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 border-e border-gray-200 pt-7 pb-10 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-custom-bg-100 dark:[&::-webkit-scrollbar-thumb]:bg-custom-bg-200 bg-neutral-100 text-gray-800 dark:bg-custom-bg dark:border-neutral-700"
			>
				<div className="px-6">
					<Link
